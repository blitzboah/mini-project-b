  ...
  return (
    <nav className="flex justify-center items-center flex-wrap bg-gray-900 p-4">
      ...
      <div className="flex justify-center items-center space-x-4">
        ...
        <Link to="/driver" className="text-white hover:text-blue-500 underline-none">Login</Link>
      </div>
    </nav>
  )
}
      ...
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-md w-full mt-20">
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          <div>
            ...
            <div className="input-group">
              <label htmlFor="phoneNumber" className="text-left block text-gray-700 text-sm font-bold mb-2">Phone Number:</label>
              <input type="text" className="text-left border border-gray-400 rounded px-3 py-2 w-full" name="driverPhone" value={formData.phoneNumber} onChange={handleInputChange} required size="70" />
            </div>
            <div className="input-group">
            ...
            <div className="input-group">
              ...
              <input type="text" name="driverAddress" className="border border-gray-400 rounded px-3 py-2 w-full" value={formData.password} onChange={handleInputChange} required size="70" />
            </div>
            <div className="input-group">
              <label htmlFor="expiryDate" className="text-left block text-gray-700 text-sm font-bold mb-2">Date of Expiry of license:</label>
              <input type="date" className="border border-gray-400 rounded px-3 py-2 w-full" name="dateOfExpiry" value={formData.expiryDate} onChange={handleInputChange} min={new Date().toISOString().split("T")[0]} required />
            </div>
            <div className="input-group">
