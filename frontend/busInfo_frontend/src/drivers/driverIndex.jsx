      ...
      <div className="container mx-auto py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="feature-box text-center">
            ...
            <p className="text-white mt-2">
              At BusInfo we work as a team try to deliver the best possible
              features.
            </p>
          </div>
          <div className="feature-box text-center">
    ...
    <section className="bg-gray-700 text-white p-10">
      <div className="container-fluid">
        ...
        <p className="service" style={{ fontSize: "1.15rem" }}>
          ...
          registered with your agency as well we keep track of the permit of the
          vehicles used by your agency.
          <br />
          As the world is moving at fast pace and everyone is getting adapted to
...
function Footer() {
  return (
    <footer id="footer" className="bg-gray-500 py-4">
      <button className="btn btn-lg mr-4">
