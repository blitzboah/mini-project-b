    ...
    <div className="flex justify-center items-center h-screen bg-gray-800">
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-md w-full">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/driverPage" className="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
            Forgot Password?
          </Link>
        </div>
        <div className="mt-4 text-center text-gray-600">
          Don't have an account? <Link to="/driverReg" className="text-blue-500 hover:underline">Sign up here</Link>
        </div>
      </div>
    </div>
  );
