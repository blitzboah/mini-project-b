...
function Features() {
  return (
    <section className="bg-gray-500 text-white p-8">
      <div className="container mx-auto py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="feature-box text-center">
            <FontAwesomeIcon icon={faCheckCircle} className="text-6xl text-gray-900" />
          ...
          <div className="feature-box text-center">
            <FontAwesomeIcon icon={faUsers} className="text-6xl text-gray-900" />
          ...
          <div className="feature-box text-center">
            <FontAwesomeIcon icon={faHeart} className="text-6xl text-gray-900" />
